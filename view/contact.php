				...
				<div class="col-lg-3">
					<div class="contact_info">
						...
						<div class="info_item">
							...
							<h6><a href="#">0369 469 525</a></h6>
							<p>Thứ 2 đến thứ 6 từ 9 giờ đến 18 giờ</p>
						</div>
						<div class="info_item">
				...
				<div class="col-lg-9">
					<form class="row contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
						<div class="col-md-6">
							...
							<div class="form-group">
								<input type="text" class="form-control" id="subject" name="subject" placeholder="Nhập mục tiêu của bạn" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập mục tiêu của bạn'">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<textarea class="form-control" name="message" id="message" rows="1" placeholder="Nhập lời nhắn của bạn" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập lời nhắn của bạn'"></textarea>
							</div>
						</div>
