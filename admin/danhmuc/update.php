        ...
        <div class="row-form">
            ...
            <div class="container">
                <form action="index.php?act=updatedm" method="post">
                    ...
                    <div class="form-group">
                        <label for="pwd">Name Category</label>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <input type="submit" value="Update" name="capnhapdm" class="form-control " style=" width:120px;background: linear-gradient(131deg, rgba(255,117,0,1) 12%, rgba(255,184,0,1) 86%); color:#fff;">
                        ...
                        <a href="index.php?act=lisdm"><input type="button" value="List" class="btn btn-default border-0" style="margin:0 0 15px 15px; width:120px; background: linear-gradient(131deg, rgba(255,117,0,1) 12%, rgba(255,184,0,1) 86%); color:#fff;"></a>
                    </div>
